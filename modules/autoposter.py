...
async def generate_post(is_morning: bool = True, forced_rubric: str = None, forced_skin: str = None):
    ...
    if is_targeted:
        ...
        structure_instruction = (
            "СТРУКТУРА ПОСТА (КРИТИЧЕСКОЕ ТРЕБОВАНИЕ — СТРОГО 4 АБЗАЦА):\n"
            "Твой текст должен состоять ровно из 4 коротких, емких абзацев:\n"
            "1. Абзац 1 (Хук): Начинай сразу с шокирующего исторического/научного факта, даты, парадокса или эксперимента, ломающего привычную картину мира. Никаких вступлений.\n"
            "2. Абзац 2 (Развитие интриги): Саспенс. Что именно пошло не так / удивило ученых / скрыто за гранью понимания.\n"
            "3. Абзац 3 (Реальное применение/Глубинная суть): Как это связано с природой человека, кармой, арканами или скрытыми возможностями.\n"
            "4. Абзац 4 (Открытый экзистенциальный вопрос): Напряженный вопрос к аудитории, вызывающий непреодолимое желание спорить в комментариях.\n"
            "СТРОГО СОБЛЮДАЙ ЭТУ 4-АБЗАЦНУЮ СТРУКТУРУ. Никаких дополнительных абзацев. "
            "Поскольку пост должен состоять строго из 4 абзацев, твой динамический CTA должен быть гармонично интегрирован в конец 4-го абзаца (вместе с экзистенциальным вопросом), либо заменять/дополнять его, не создавая отдельный 5-й абзац."
        )
    else:
