...
@labeler.message(text=["СЕКС (РАЗОВАЯ)", "ДЕНЬГИ (РАЗОВАЯ)", "ТЕНЬ (РАЗОВАЯ)", "ФИНАЛ (РАЗОВАЯ)", "БАНДЛ", "👄 СЕКС (РАЗОВАЯ)", "💰 ДЕНЬГИ (РАЗОВАЯ)", "🌘 ТЕНЬ (РАЗОВАЯ)", "🏁 ФИНАЛ (РАЗОВАЯ)", "📦 БАНДЛ", "🔮 ВОПРОС СУДЬБЕ", "ТВОЯ СЕКСУАЛЬНАЯ ЭНЕРГИЯ", "КОД ТВОЕГО БОГАТСТВА", "ТВОИ СКРЫТЫЕ ГРАНИ", "ТВОЙ ИСТИННЫЙ ПУТЬ", "ЗОЛОТОЙ АРХИВ", "👄 ТВОЯ СЕКСУАЛЬНАЯ ЭНЕРГИЯ", "💰 КОД ТВОЕГО БОГАТСТВА", "🌘 ТВОИ СКРЫТЫЕ ГРАНИ", "🏁 ТВОЙ ИСТИННЫЙ ПУТЬ", "📦 ЗОЛОТОЙ АРХИВ"])
