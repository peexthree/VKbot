...
async def generate_section(section: str, date: str, time: str, city: str) -> str | None:
    ...
    style_instruction = (
        ...
        "только короткие тире (-), только КАПС для акцентов и заголовков. "
