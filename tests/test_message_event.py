...
async def test_message_event_handler_main_menu():
    ...
    # Mock DB functions
    with patch("modules.payments.callbacks.get_user", return_value=mock_user), \
         patch("modules.payments.callbacks.update_user", new_callable=AsyncMock) as mock_update, \
        ...
        mock_redis.set.assert_any_call("event_answered:test_event_12345", "1", ex=30, nx=True)
